...
public class OrderEventsListener {
    ...
    public void receiveMessage(@Payload TextMessage textMessage) throws Exception {
        ...
        try {
            String reservationId = reservationService.getReservation(orderId, userId);
            reservationService.makeReservation(reservationId, orderCreatedEvent.getCartNumber());
            ...
            reservationService.handleReservationError(e, orderId, userId);
        }
    }
}
